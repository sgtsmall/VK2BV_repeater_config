...
$FavmarcTG = "1-WW CALL-TG1-1,1-WW EN-TG13-13,1-UAEN1-TG113-113,1-UAEN2-TG123-123,2-VKZL-TG5-5,2-VK-TG505-505,1-TECH-TG100-100";
@FavmarcTG = split(',',$FavmarcTG);
#
#Simplex talk groups only used in contacts 
$FavsimpTG = "1-VK-SIMPLEX-505,1-DMR-SIMPLEX-130001,1-LOCAL-DV4M-9";
